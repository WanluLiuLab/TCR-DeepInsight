...
class TCR:
    ...
    def __eq__(self, other):
        if self._individual is None and other._individual is None:
            return self.cdr3a == other.cdr3a and self.cdr3b == other.cdr3b and self.trav == other.trav and self.trbv == other.trbv and self.traj == other.traj and self.trbj == other.trbj
        else:
            return self.cdr3a == other.cdr3a and self.cdr3b == other.cdr3b and self.trav == other.trav and self.trbv == other.trbv and self.traj == other.traj and self.trbj == other.trbj and self.individual == other.individual
